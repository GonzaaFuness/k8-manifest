...
STATIC_WEBSITE_REPO="${STATIC_WEBSITE_REPO:-https://github.com/GonzaaFuness/static-website}"
K8S_MANIFESTS_REPO="${K8S_MANIFESTS_REPO:-https://github.com/GonzaaFuness/k8s-manifests}"
